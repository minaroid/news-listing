package com.minaroid.newsapp.presentation.screens
...
import com.minaroid.newsapp.common.utils.Resource.Loading
...
fun HomeScreen(navController: NavController, viewModel: NewsViewModel = hiltViewModel()) {
    ...
    val itemsResState = viewModel.articles.collectAsState()
    val res = itemsResState.value
